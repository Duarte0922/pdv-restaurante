...
function renderCategoriasCx(){
  ...
  categoriasCx.forEach((c,i)=>{
    const el=document.createElement('div');
    el.style.cssText='flex:1 1 90px;min-width:90px;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:110px;border-radius:14px;padding:10px 6px;gap:8px;font-size:14px;line-height:1.2;text-align:center;border:1px solid var(--border3);background:linear-gradient(180deg,#232a25,#171c18);color:var(--txt);cursor:pointer;transition:all .15s;';
